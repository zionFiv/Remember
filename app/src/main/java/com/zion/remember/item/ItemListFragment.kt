...
import com.zion.remember.databinding.FragmentItemListBinding
import com.zion.remember.databinding.ItemListContentBinding
...
class ItemListFragment : Fragment() {
    ...
    private val unhandledKeyEventListenerCompat = ViewCompat.OnUnhandledKeyEventListenerCompat { v, event ->
        if (event.keyCode == KeyEvent.KEYCODE_Z ) {
            ...
            true
        } else if (event.keyCode == KeyEvent.KEYCODE_F) {
            Toast.makeText(
                    v.context,
